...
export const ARABIZI_DICTIONARY: Record<string, string> = {
    ...
    'That slot is taken. Do you have another time in mind?': 'Hal maw3ed ma7jouz. Fi wa2t tene b belak?',
    'That slot is already taken. Do you have another time in mind?': 'Hal maw3ed ma7jouz. fi wa2t tene b belak?',
