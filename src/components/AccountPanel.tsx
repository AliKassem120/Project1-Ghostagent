                            ...
                            {isGoogleUser ? (
                                <div className="p-5 rounded-2xl bg-primary/5 border border-primary/10 space-y-4">
                                    ...
                                    <div className="text-center space-y-2">
                                        <h3 className="text-sm font-bold text-white">Identity Managed by Google</h3>
                                    ...
                                    <a
                                        ...
                                        className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-white/5 border border-white/10 text-[11px] font-bold text-white hover:bg-white/10 transition-all"
                                    >
