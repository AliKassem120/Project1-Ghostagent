...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-[100dvh] text-foreground overflow-x-clip relative selection:bg-primary/30">
      ...
      {/* ═══════════════════════════════════════════════════
         SECTION: MULTI-CHANNEL FEATURES (WhatsApp + Instagram)
         ═══════════════════════════════════════════════════ */}
      <section className="relative py-20 md:py-32 px-4 md:px-6 z-10 border-t border-border/50">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-black mb-6 text-foreground tracking-tighter">
              One AI Brain.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
            {/* Card 1: WhatsApp Native Flows — wide */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              whileHover={{ y: -4 }}
              className="glass-frosted border border-border rounded-[2.5rem] p-8 group relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-3 tracking-tight">WhatsApp Native Flows</h3>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-3 tracking-tight">Marketing Broadcasts</h3>
                <p className="text-muted-foreground leading-relaxed font-medium mb-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-3 tracking-tight">Shared AI Brain</h3>
                <p className="text-muted-foreground leading-relaxed font-medium mb-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-3 tracking-tight">Unified Inbox</h3>
                <p className="text-muted-foreground leading-relaxed font-medium mb-6">
