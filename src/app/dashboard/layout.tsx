    ...
    return (
        <>
            ...
            <aside className={clsx(
                "w-[240px] border-r border-white/[0.06] bg-[#0E0F15]/80 backdrop-blur-xl p-5 flex flex-col fixed h-full z-50 transition-transform duration-300 lg:translate-x-0",
...
function DashboardContent({ children, toggleSidebar }: { children: React.ReactNode; toggleSidebar: () => void }) {
    return (
        <div className="flex-1 flex flex-col min-w-0">
            {/* Mobile Header */}
            <header className="lg:hidden h-14 border-b border-white/[0.06] bg-[#0B0C10]/80 fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-4 backdrop-blur-xl">
            ...
            <div className="flex-1 lg:ml-[240px] relative z-10">
                ...
                <main className="p-4 lg:p-6 pt-[72px] lg:pt-6 overflow-y-auto min-h-screen relative z-10">
