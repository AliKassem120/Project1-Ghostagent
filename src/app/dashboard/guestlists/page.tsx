...
export default function Page() {
    return (
        <div className="min-h-[80vh] flex flex-col relative w-full">
            <div className="mb-6">
                <h1 className="text-2xl font-bold tracking-tight text-white">Guestlists</h1>
            ...
            >
                ...
                <h2 className="text-xl font-bold text-white mb-2 tracking-tight">Guestlists features coming soon.</h2>
