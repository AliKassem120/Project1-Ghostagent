    ...
    return (
        <div className="min-h-[80vh] flex flex-col relative w-full">
            <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground mt-1">Manage your menu items settings and operations.</p>
            </div>
            ...
            >
                ...
                <h2 className="text-xl font-bold text-foreground mb-2 tracking-tight">Menu Items features coming soon.</h2>
