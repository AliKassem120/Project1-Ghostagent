    ...
    return (
        <div className="min-h-[80vh] flex flex-col relative w-full">
            <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground mt-1">Manage your orders settings and operations.</p>
            </div>
            ...
            >
                ...
                <h2 className="text-xl font-bold text-foreground mb-2 tracking-tight">Orders features coming soon.</h2>
                <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
                    We're actively working on bringing powerful orders capabilities directly to your dashboard. Stay tuned!
                </p>
