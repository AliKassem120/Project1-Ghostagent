...
import { Instagram, Loader2, Sparkles, Lock, Trash2, MessageCircle, Check, Phone } from 'lucide-react';
                    ...
                    {instagramStatus === null ? (
                        ...
                        <>
                            {instagramStatus.accounts.length > 0 && (
                                <div className="space-y-3">
                                    {instagramStatus.accounts.map((acc: any) => (
                                    ...
                                    <div className="flex justify-end pt-2">
                                        <Link
                                            ...
                                            className="px-6 py-2.5 bg-surface-3 border border-border text-foreground font-bold rounded-xl hover:bg-surface-4 transition-all flex items-center justify-center gap-2 text-sm w-full sm:w-auto shrink-0"
                                        >
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between p-5 bg-surface-2 rounded-2xl border border-border gap-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto">
                                        ...
                                        <button
                                            ...
                                            disabled={connecting}
                                            className="w-full sm:w-auto px-6 py-2.5 bg-pink-500 text-black font-bold rounded-xl hover:bg-pink-400 transition-all flex items-center justify-center gap-2 text-sm shadow-[0_0_20px_rgba(236,72,153,0.2)] disabled:opacity-50 shrink-0"
                                        >
