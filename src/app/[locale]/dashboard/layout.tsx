                                    ...
                                    {wsLoading ? (
                                        ...
                                        <>
                                            ...
                                            <p className="text-[9px] text-muted-foreground truncate">
                                                {activeWorkspace?.instagram_username ? `@${activeWorkspace.instagram_username}` : ''}
                                                {activeWorkspace?.instagram_username && activeWorkspace?.whatsapp_phone_number_id ? ' • ' : ''}
                                                {activeWorkspace?.whatsapp_phone_number_id ? 'WhatsApp' : ''}
                                                {!activeWorkspace?.instagram_username && !activeWorkspace?.whatsapp_phone_number_id ? 'No channels connected' : ''}
                                            </p>
                                        </>
                                    )}
                                </div>
                                        ...
                                        {workspaces.map(ws => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[9px] text-muted-foreground truncate">
                                                        {ws.instagram_username ? `@${ws.instagram_username}` : ''}
                                                        {ws.instagram_username && ws.whatsapp_phone_number_id ? ' • ' : ''}
                                                        {ws.whatsapp_phone_number_id ? 'WhatsApp' : ''}
                                                        {!ws.instagram_username && !ws.whatsapp_phone_number_id ? ws.business_type : ''}
                                                    </p>
                                                </div>
